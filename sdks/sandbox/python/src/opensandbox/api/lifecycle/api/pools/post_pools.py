...
from ...models.create_pool_request import ApiCreatePoolRequest
from ...models.error_response import ErrorResponse
from ...models.pool_response import ApiPoolResponse
from ...types import Response


def _get_kwargs(*, body: ApiCreatePoolRequest) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code in (400, 401, 409, 500, 501):
...
def sync_detailed(
    *, client: AuthenticatedClient | Client, body: ApiCreatePoolRequest
) -> Response[ApiPoolResponse | ErrorResponse]:
